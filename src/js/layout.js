function setLayout() {
	...
	Array.from(document.getElementsByTagName('section')).forEach(function(section) {
		var title = section.getElementsByClassName('section-title')[0];
		var container = section.getElementsByClassName('container')[0];
		var sectionPaddingLeft = window.getComputedStyle(section)['padding-left'];
